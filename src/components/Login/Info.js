...
import { Container, Dropdown, Header, Menu, Button,Accordion,Icon } from "semantic-ui-react";
export default class AccordionExampleStandard extends Component {
	state = { activeIndex: 0,activeDuty: 0 ,activeProperty: 0 ,activeDuty2:0,activeProperty2:0}
	
  
	handleClick = (e, titleProps) => {
	  const { index } = titleProps
	  const { activeIndex, activeDuty, activeProperty ,activeDuty2,activeProperty2} = this.state
	  ...
	  this.setState({ activeIndex: newIndex ,activeDuty:newIndexDuty,activeProperty:newIndexProperty,activeDuty2:newIndexProperty2})
	}
					...
					<Dropdown.Menu>
						...
						<Accordion>
							...
							<Accordion.Content active={activeIndex === 0}>
								<Accordion>
									<Accordion.Title active={activeIndex === 0} index={0} onClick={this.handleClickDuty}>
										<Icon name = "dropdown"/>
										<p>	หน้าที่</p>
									</Accordion.Title>
								...
								<Accordion>
									<Accordion.Title active={activeIndex === 0} index={0} onClick={this.handleClickProperty}>
										<Icon name = "dropdown"/>
										<p>คุณสมบัติ</p>
									</Accordion.Title>
						...
						<Accordion>
							...
							<Accordion.Content active={activeIndex === 0}>
								<Accordion>
									<Accordion.Title active={activeIndex === 0} index={0} onClick={this.handleClickDuty2}>
										<Icon name = "dropdown"/>
									...
									<Accordion.Title active={activeIndex === 1} index={1} onClick={this.handleClickDuty2}>
										<Icon name = "dropdown"/>
										<p>	PR ฝ่าย Roadshow</p>
									</Accordion.Title>
									...
									<Accordion.Title active={activeIndex === 2} index={2} onClick={this.handleClickDuty2}>
										<Icon name = "dropdown"/>
